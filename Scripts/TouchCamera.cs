...
public class TouchCamera : MonoBehaviour {
	...
	private static readonly float[] ZoomBounds = new float[]{170f, 540f};
	...
	void Update() {
		BoundsX = new float[]{ cam.orthographicSize / 0.5625f, (1080 - cam.orthographicSize) / 0.5625f };
		BoundsZ = new float[]{ cam.orthographicSize, 1080f - cam.orthographicSize };
	...
	public void UsingScrollbar(){
		isBuilding = true;
	}
	public void NotUsingScrollbar(){
		isBuilding = false;
	}
}
